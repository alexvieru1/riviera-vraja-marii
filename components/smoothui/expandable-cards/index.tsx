    ...
    >
      ...
      >
        {cards.map((card) => (
          <motion.div
            animate={{
              width: selectedCard === card.id 
                ? (isMobile ? "300px" : "500px") 
                : (isMobile ? "160px" : "200px"),
            }}
            className={`relative mr-4 h-75 shrink-0 cursor-pointer overflow-hidden rounded-2xl border bg-background shadow-lg ${cardClassName}`}
          ...
          >
            <div className="relative h-full w-full">
              ...
              <motion.div 
                animate={{
                  marginRight: selectedCard === card.id 
                    ? (isMobile ? 140 : 300) 
                    : 0
                }}
                transition={{
              ...
              {selectedCard === card.id && (
                ...
                >
                  <motion.div
                    ...
                    className="flex h-full flex-col justify-between p-4 md:p-8 overflow-y-auto"
