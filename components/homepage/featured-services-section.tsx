      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center mt-6">
          <Link href="/servicii-recuperare-medicala">
            <Button size="lg" variant="outline" className="group text-lg px-8 py-6 rounded-full border-black/10 hover:border-black/30 bg-background text-[#8b7355] hover:text-[#6b5644] transition-all duration-300">
